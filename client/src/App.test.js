import { rendersWithoutCrashing, matchesSnapshot, AppRouterWrapper } from './setupTests';
import { render, screen, fireEvent, cleanup } from '@testing-library/react';

const authenticatedUser = {isAuth: true, id: 'adsf523d8fs', token: 'Bearer 3209f8f.adsfu9823.324s9asf789'};
...
const Signup = (user = unauthenticatedUser) => AppRouterWrapper('/signup', user)
const Logout = (user = athenticatedUser) => AppRouterWrapper('/logout', user)
const Dashboard = (user = authenticatedUser) => AppRouterWrapper('/dashboard', user)
