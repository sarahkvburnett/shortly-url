...
import { rendersWithoutCrashing, matchesSnapshot, ComponentWrapper, sampleLinks } from '../../../setupTests';
...
it('renders dash link without crashing', () => rendersWithoutCrashing(DashLinksWrapper));
