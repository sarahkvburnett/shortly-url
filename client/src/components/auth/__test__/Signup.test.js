	...
	rest.post("/signup", (req, res, ctx) => {
		return res(
			ctx.json({
				...
				email: "harriet.tripp@outlook.com",
				password:
					"$2a$10$fa0d9DBBN96GR.i9HU/U7uSe08s4Zl6Ik8t9GC/mw9j7VxaDPJoNi",
...
it("renders signup without crashing", () =>
	rendersWithoutCrashing(ValidSignupWrapper));
...
it("invalid user shows error", async () => {
	...
	expect(screen.getByTestId("errors")).toHaveTextContent(
		"Please enter your last namePlease enter your emailPlease confirm your passwordPassword must be at least 6 charactersEntered passwords are not the same"
	);
});
